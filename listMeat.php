            ...
            <div class="main page-width">
              <!--Main content starts here!-->
                ...
                <div class="card-content">
                    <h5 class="center-text">Meat List</h5>
                </div>
                        ...
                        for ($i = 0; $i < count($list); $i++) { 
                          ...
                          $desc = str_replace("_"," ",$stringdesc);
                            echo '<tr>';
                                ...
                                echo '<td>' . 
                                "<a href = 'deleteProduct.php?aisle=meat&id=$id' class='btn custom-button'><i class='fa fa-trash'></i></button>
                                <a href = 'addeditproducts/editfood.php?aisle=meat&id=$id' class = 'btn custom-button'><i class = 'fa fa-edit'</i></button>" 
                                . '</td>';
                            echo '</tr>';
                        }
                    ?>
