<?php  
    ...
    $id = $_GET['id'];
    $email = $_GET['email'];
    $xml = simplexml_load_file('database/users/' . $email . '.xml');
  ...
  <body>
    ...
    <div class="page-container">
        <div class="content-wrapper">
            ...
            <form method = "POST" action = <?php "editUser.php?email=$email&id=$id" ?>>
              <div class="card-content">
                <h5 class="center-text"><b>Edit User</b></h5>
              </div>
                  ...
                  <div class="edit-field-type">
                    ...
                    <div class="edit-field">
                    <input value=<?php echo $email;?> name = "email" class="barContent">
                    </div>
                  </div>
                  <div class="edit-field-type">
                    <div class="card-sub-content">
                    ...
                    <div class="edit-field">
                    <input value=<?php echo $password;?> name = "password" class="barContent">
                    </div>
                  </div>
                  <div class="edit-field-type">
                    <div class="card-sub-content">
                    ...
                    <div class="edit-field">
                    <input value=<?php echo $address;?> name = "address" class="barContent">
                    </div>
                  </div>
                  <div class="edit-field-type">
                    <div class="card-sub-content">
                    ...
                    <div class="edit-field">
                    <input value=<?php echo $admin;?> name = "admin" class="barContent">
                    </div>
                  </div>
                  

                  <div class="saveButton"> 
                    <input type="submit" class="btn custom-button" name = "editUser" value="Save"></input>
                  </div>
            </form>
                  <hr class="clear">
